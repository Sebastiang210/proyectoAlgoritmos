...
class ColorFormatter(logging.Formatter):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not _colorama_initialized:
            init(autoreset=True)  # Inicializa colorama (una sola vez: re-llamar
            # envuelve sys.stdout de nuevo cada vez y apila wrappers de
            # AnsiToWin32, causando RecursionError tras ~150 instancias)
