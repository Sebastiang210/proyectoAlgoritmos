...
class System:
    ...
    @property
    def indices(self):
        """Alias de indices_ncubos para compatibilidad con estrategias nuevas."""
        return self.indices_ncubos

    @property
    def dims(self):
        """Alias de dims_ncubos para compatibilidad con estrategias nuevas."""
        return self.dims_ncubos
